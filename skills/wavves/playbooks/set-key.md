...
Route: **wavves** (`/wavves set-key`) → leaf **set-key** (`/set-key`)

```
- [ ] 1. Read skills/set-key/SKILL.md in full.
- [ ] 2. Resolve repo / env file / key name (default klosr GOOGLE_MAPS_API_KEY).
