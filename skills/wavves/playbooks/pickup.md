...
- [ ] 6. **Mandatory reconcile branch** for any in-flight wave orch (do this
        ...
        remeasure leave-act + disk artifacts, then take exactly one branch:
        - `yield_awaiting_children` → same-turn remeasure
        ...
        - `return_to_O0` (or yield remeasure found rollup+gate) → reconcile
        ...
        disk remeasure is authority (Cursor harness gap).
